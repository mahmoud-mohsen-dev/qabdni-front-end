...
export default function ErrorPage() {
  ...
  return (
    <div id="error-page" className="flex min-h-screen items-center justify-center px-40">
      <div className="font-Libre flex max-w-[620px] flex-col gap-5">
        ...
        <Link to="/" style={{ width: 'fit-content', borderRadius: '8px' }}>
          <Button color="blue" paddingSize="sm" fontSize="sm" styles="font-medium hover:bg-blue/accent">
            <p>Back to Home Page</p>
          </Button>
        </Link>
      </div>
      <img src="/public/images/404 Error.svg" alt="404 error page not found" className="max-w-[500px]" />
    </div>
  );
}
